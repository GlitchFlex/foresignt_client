...
contract BettingContract {
    ...
    function createGame(string memory _description,  string[] memory _options) public {
        //games.push(Game(_description, true, new uint256[](0), 0, 0, GameState.OPEN, _options));
        games.push(Game(_description, true, new uint256[](0), 0, 0, GameState.OPEN, _options));
        numGames++;
        emit NewGame(_description);
    }
